...
int main()
{
	...
	Vertex triangle_vertices[] = {
		Vertex(glm::vec3(-0.5, -0.5, 0), glm::vec2(0, 0), glm::vec3(0, 0, 0)),
		Vertex(glm::vec3(0, 0.5, 0), glm::vec2(1.0, 0), glm::vec3(0, 0, 0)),
		Vertex(glm::vec3(0.5, -0.5, 0), glm::vec2(1.0, 1.0), glm::vec3(0, 0, 0)),
	};
